        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <motion.div
              ...
              className="bg-gray-800 rounded-2xl shadow-2xl p-8 text-center hover:bg-gray-700 transition duration-300"
            >
              <div className="text-5xl mb-6 text-white">{service.icon}</div>
